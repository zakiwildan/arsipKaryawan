                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="jns_berkas" class="form-control">
                                                    ...
                                                    @foreach ($jenisberkas as $jb)
                                                        <option value="{{ $jb->kd_jns_berkas }}">
                                                            {{ $jb->nm_jns_berkas }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    @foreach ($berkas as $b)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="/DaftarBerkas/Delete/{{ $b->id_berkas }}"
